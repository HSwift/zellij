...
#[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum Payload {
        ...
        WebSocketOpenPayload(super::WebSocketOpenPayload),
        #[prost(message, tag="162")]
        WebSocketSendPayload(super::WebSocketSendPayload),
        #[prost(message, tag="163")]
        WebSocketClosePayload(super::WebSocketClosePayload),
    }
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
impl CommandName {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            CommandName::WebSocketOpen => "WebSocketOpen",
            CommandName::WebSocketSend => "WebSocketSend",
            CommandName::WebSocketClose => "WebSocketClose",
        }
    }
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "WebSocketOpen" => Some(Self::WebSocketOpen),
            "WebSocketSend" => Some(Self::WebSocketSend),
            "WebSocketClose" => Some(Self::WebSocketClose),
            _ => None,
        }
    }
}
